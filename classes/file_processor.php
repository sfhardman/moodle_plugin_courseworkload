...
abstract class file_processor {
  ...
  abstract protected function get_workload_from_file_handle($file_handle);

  protected function get_file_path($file_handle) {
    $md = stream_get_meta_data($file_handle);
    return $md['uri'];
  }
  ...
  public function get_workload_item() {
    ...
    try {
      return $this->get_workload_from_file_handle($file_handle);
    } finally {
        fclose($file_handle);
    }
  }
